...
import { Briefcase, ChevronRight, FlaskConical, Users } from 'lucide-react';
        ...
        <div className="mt-10 flex gap-2">
          <button
            ...
            className={`px-5 py-2 rounded-full text-sm flex items-center gap-2 transition-all ${
              tab === 'research' ? 'bg-[#5eead4] text-[#05060a]' : 'glass text-[#8a93a8] hover:text-white'
            }`}
          >
          ...
          <button
            ...
            className={`px-5 py-2 rounded-full text-sm flex items-center gap-2 transition-all ${
              tab === 'leadership' ? 'bg-[#5eead4] text-[#05060a]' : 'glass text-[#8a93a8] hover:text-white'
            }`}
          >
        ...
        <div className="mt-10 relative">
          ...
          <div className="space-y-8">
            {list.map((item, i) => (
              ...
              >
                {/* Node */}
                <div className="absolute left-0 top-1.5 w-4 h-4 rounded-full bg-[#05060a] border-2 border-[#5eead4] flex items-center justify-center">
                  <div className="w-1.5 h-1.5 rounded-full bg-[#5eead4]" />
                </div>

                <div className="glass rounded-2xl p-6 hover:translate-x-1 transition-transform duration-300">
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    ...
                    <span className="text-xs font-mono px-3 py-1 rounded-full bg-[#5eead4]/10 text-[#5eead4] whitespace-nowrap">
                      {item.period}
