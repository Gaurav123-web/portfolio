      ...
      <div className="max-w-5xl mx-auto text-center">
        ...
        >
          ...
          <h2 className="text-4xl md:text-6xl font-bold">
            Let's advance <span className="gradient-text">science</span> together
          </h2>
        ...
        >
          {contacts.map((c) => (
            <a
              ...
              rel="noreferrer"
              className="glass rounded-2xl p-5 flex flex-col items-center gap-3 hover:glow-accent hover:scale-105 transition-all duration-300"
            >
              <div className="w-11 h-11 rounded-xl bg-[#5eead4]/10 flex items-center justify-center">
        ...
        <motion.a
          ...
          className="mt-10 inline-flex items-center gap-2 px-8 py-4 rounded-full bg-[#5eead4] text-[#05060a] font-medium hover:bg-white transition-colors duration-300 glow-accent"
        >
